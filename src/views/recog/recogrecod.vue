    ...
    <div class="content">
      <el-table :data="param.list" v-loading="param.loading" element-loading-text="加载中,请等待">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="more(scope.row)">查看详情</el-button>
          </template>
        </el-table-column>
        ...
        <ul class="more-dialog-right">
          <li class="more-dialog-right-li" v-for="value in this.selected">
            <div>
              ...
              <div class="show_library">
                <span class="lib_message" v-if="value.libName">{{value.libName}}</span>
      ...
      more(row) {
        ...
        List(row.channel_id, row.live_id, row.timeStamp0).then(resp => {
          ...
          for (var i = 0; i < this.selected.length; i++) {
            ...
            this.selected[i].regFaceData = "data:image/jpeg;base64," + this.selected[i].regFaceData;
...
<style scoped>
  ...
  .button-li1, .button-li2, .button-li3, .button-li4, .button-li5, .button-li6, .button-li7 {
    float: left;
  }
