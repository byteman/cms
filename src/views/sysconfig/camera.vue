      ...
      <el-form ref="form" :model="camera" label-width="100px" :rules="rules">
        ...
        <el-col :span="11">
          ...
          <el-form-item label="URL" >
            ...
            <el-input :disabled="filedEnable" v-model="camera.cameraChannel" placeholder="海康、大华、宇视相机的主码流填live"></el-input>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      snap: {},
      rules: {
        cameraId: [{ required: true, validator: id_validator, trigger: "blur" }]
      },
      prew: {},
      showChannel: false,
      showVms: false,
