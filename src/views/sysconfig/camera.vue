<template>
  <div class="container">
    <!-- <div class="header">
        ...
        <el-input v-model="formInline.cameraId" placeholder="请输入相机编号"></el-input>
        </el-form-item>
    ...
    <div class="content">
      ...
      <el-table-column prop="cameraState" label="设备状态"  :filters="cameraStatusFilters"  :filter-method="filterCameraStatus"
